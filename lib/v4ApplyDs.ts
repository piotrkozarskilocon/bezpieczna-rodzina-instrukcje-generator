...
function commonRules(
  ...
  return [
    ...
    "",
    "GDY TREŚĆ NIE MIEŚCI SIĘ NA STRONIE — 4 STRATEGIE (W TEJ KOLEJNOŚCI):",
    "Tekst NIE jest niemożliwy do zmieszczenia — ZAWSZE jest sposób.",
    "1. **Powiększ pole**: zwiększ h_mm boxa jeśli jest miejsce poniżej (max do margin).",
    "2. **Zmniejsz font**: zmniejsz font_size_pt body do 6pt min (czytelność OK przy druku).",
    "3. **Przesuń pole**: jeśli inne elementy zajmują miejsce, układaj logicznie pionowo.",
    "4. **Split na 2 strony**: dopiero gdy żadna z powyższych nie pomaga — endpoint",
    "   auto-split-pages dzieli stronę na (1/2) i (2/2) zachowując 100% treści.",
    "ABSOLUTNIE NIE skracaj h_mm do 4mm bo wtedy tekst znika — to gorsze niż overflow.",
    "",
