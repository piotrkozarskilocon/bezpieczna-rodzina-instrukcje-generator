...
export function buildSystemPrompt(
  ...
  return [
    ...
    "- Czcionki w punktach (pt). Nagłówki: 11-14pt, body: 7-8pt, podpisy: 6pt.",
    "- TWARDA ZASADA: NIGDY font_size_pt < 6pt dla tekstu/podpisów — 6pt to próg",
    "  czytelności w druku. Jeśli treść nie mieści się przy 6pt, podziel ją na",
    "  więcej stron lub powiększ pole, ale NIE zmniejszaj fontu poniżej 6pt.",
    ...
    "  w prawym dolnym rogu każdej strony, font 6pt.",
    "",
